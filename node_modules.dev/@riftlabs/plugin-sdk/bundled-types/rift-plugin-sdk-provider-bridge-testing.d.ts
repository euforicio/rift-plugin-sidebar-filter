...
declare const threadEventSchema: z.ZodPipe<z.ZodUnknown, z.ZodUnion<readonly [z.ZodIntersection<z.ZodDiscriminatedUnion<[z.ZodObject<{
    ...
    entries: z.ZodArray<z.ZodObject<{
        ...
        source: z.ZodUnion<readonly [z.ZodLiteral<"shell">, z.ZodObject<{
            plugin: z.ZodString;
        }, z.core.$strict>]>;
        value: z.ZodUnion<readonly [z.ZodString, z.ZodObject<{
            masked: z.ZodLiteral<true>;
        }, z.core.$strict>]>;
    }, z.core.$strict>>;
    providerThreadId: z.ZodString;
    threadId: z.ZodString;
    type: z.ZodLiteral<"provider.env-resolved">;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodString & z.ZodType<`${string}/${string}`, string, z.core.$ZodTypeInternals<`${string}/${string}`, string>>;
    payload: z.ZodType<JsonValue, unknown, z.core.$ZodTypeInternals<JsonValue, unknown>>;
    providerThreadId: z.ZodString;
...
interface DeltaAssembler {
    ...
    getRiftItemId(threadId: string, providerItemId: string): string | undefined;
    getProviderItemId(threadId: string, riftItemId: string): string | undefined;
    getRiftTurnId(threadId: string, providerTurnId: string): string | undefined;
    getProviderTurnId(threadId: string, riftTurnId: string): string | undefined;
